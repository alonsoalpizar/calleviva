...
export default function SkinnedCharacterTest() {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-purple-900 to-gray-900 flex">
      {/* Panel de control */}
      <div className="w-96 bg-gray-800 p-4 overflow-y-auto text-white">
        <h1 className="text-xl font-bold mb-2 text-purple-400">
          Skinned Character Test
        </h1>

        <div className="bg-green-900/50 border border-green-500 rounded p-2 mb-4">
          <p className="text-xs text-green-300">
            ¡NUEVO! Ropa con SKINNING real.
            La ropa ahora se deforma con las animaciones del cuerpo.
          </p>
        </div>
        ...
        <h2 className="text-lg font-semibold mb-3 text-purple-300">Customización</h2>
              ...
              return (
                <button
                  ...
                  className={`w-8 h-8 rounded-full border-2 ${
                    recipe.body === body ? 'border-white scale-110' : 'border-gray-600'
                  }`}
        ...
        <div className="mb-3">
          <label className="block text-xs text-gray-400 mb-1">
            Ropa <span className="text-green-400">(SKINNED!)</span>:
          </label>
          <select
            value={recipe.outerwear || ''}
            onChange={(e) => updateRecipe('outerwear', e.target.value || undefined)}
            className="w-full bg-gray-700 border border-green-600 rounded px-2 py-1 text-sm"
          >
            <option value="">Ninguno</option>
        ...
        <div className="mb-3">
          <label className="block text-xs text-gray-400 mb-1">
            Pantalón <span className="text-green-400">(SKINNED!)</span>:
          </label>
          <select
            value={recipe.pants || ''}
        ...
        <div className="mb-3">
          <label className="block text-xs text-gray-400 mb-1">
            Zapatos <span className="text-green-400">(SKINNED!)</span>:
          </label>
          <select
            value={recipe.shoe || ''}
